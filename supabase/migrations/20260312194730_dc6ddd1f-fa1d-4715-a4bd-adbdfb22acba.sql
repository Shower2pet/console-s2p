...
-- Add showcase fields to stations
ALTER TABLE public.stations ADD COLUMN IF NOT EXISTS is_showcase boolean NOT NULL DEFAULT false;
ALTER TABLE public.stations ADD COLUMN IF NOT EXISTS showcase_title text;

-- Update get_public_stations to include showcase stations
